...
export function SeamlessLoop() {
	...
	// On first playthrough we want to start at the beginning.  After that, we want to pick up at the loop point.
	...
	this.doLoop = function() {
		...
		if (this.on_repeat) {
			this.actual[key].currentTime = 7.211;
			console.log(this.actual[key].currentTime);
		}
